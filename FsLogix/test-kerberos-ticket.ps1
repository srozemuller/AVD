...
try {
    ...
    Start-Process  -Filepath powershell.exe -ArgumentList "klist purge" -Credential $credentials -NoNewWindow
    Start-Process -Filepath powershell.exe -ArgumentList "klist get krbtgt" -Credential $credentials -NoNewWindow -WorkingDirectory '.' -RedirectStandardOutput "output.txt"
